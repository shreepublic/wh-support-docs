...
In 8.1.1, focus on accessibility improvements continued. Improvements made across many of the WCAG guideline, to reduce deviations and improve on accessibility compliance across all of the Cúram application. 
...
For more details about these features, see the [What's new in 8.1.1](/pdf/spm/SPM_WhatsNew_810.pdf) and the [8.1.1.0 release notes](/pdf/releasenotes/spm8100.pdf).

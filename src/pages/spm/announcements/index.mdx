...
* Caseworkers can now document notes and contact logs directly in the application with confidence as a new autorecovery feature ensures that data entered is kept intact even if their session times out.

* Caseworkers can now capture lengthy Notes and Contact Logs over a number of sittings, so they can manage interruptions and other priority tasks in parallel. A new configurable work-in-progress period introduces the flexibility to match different caseworker's needs. After the editable period elapses, comments can still be appended.
...
* The introduction of design tokens in Citizen Engagement enables business analysts and developers to more easily rebrand to their agency's brand guidelines, while ensuring that accessibility standards are maintained.

For more details about these features, see the [What's new in 8.0.3](/pdf/spm/SPM_Whats_new_803.pdf) in the product documentation and the [8.0.3 release notes](/pdf/releasenotes/spm-release-notes-8030.pdf).

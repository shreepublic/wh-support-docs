...
||11.5.5.0 and future fix packs|Reporting: <br />- - SPM Reporting and Analytics is supported on DB2 version 11.5.5.0 and future fix packs, mod levels and their fix packs. <br />- The SPM data warehouse can be built on this version of Db2. <br />- Reporting ETLs can be built using a technology compatible with this version of Db2. Database-as-a-Service is not supported. Container and Kubernetes Platforms are not supported.|
|IBM Db2 Standard Edition VPC Option|11.5.5.0 and future fix packs|Database-as-a-Service is not supported. Container and Kubernetes Platforms are not supported.|

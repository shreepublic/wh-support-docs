...
| Server-Side Development | 60% (25 questions) | Classes and relationships, stereotype operations, class hierarchies, code tables, message files, validation and exception handling, and importing and exporting configuration data |

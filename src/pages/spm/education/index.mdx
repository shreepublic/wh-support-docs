...
We understand that different students have different needs, and so our training is organised into specific tracks, mostly aligned with the different core role types (i.e. Business User, or Technical User). For a full picture, see [202303_Summary_SPM_Courses.pdf](/pdf/education/202303_Summary_SPM_Courses.pdf) (recommend you open in a new tab).

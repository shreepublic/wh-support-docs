...
**Note:** For important updates to the Social Program Management 8.0.2 documentation, see Documentation Addenda for 8.0.2 on this page.  
...
* PDF documentation for 5.2.1, 3.0.8, and 2.6.2 or later is availalable here.

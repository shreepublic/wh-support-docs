...
For a transitional period, before the release of the new Merative Social Program Management documentation website, any important updates or addenda to the Merative Social Program Management documentation will be added here.  

You can still rely on the online IBM® Documentation for Social Program Management 8.0.2, which was last updated in June 2022. However, the Universal Access Responsive Web Application and Social Program Management Design System assets are released more often than Social Program Management:
...
## Merative Social Program Management documentation and addenda
...
### Clarification of IBM MQ suppport on Red Hat® OpenShift®

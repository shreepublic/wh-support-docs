...
In this release, we added new features as well as enhancements to some of the existing features in Merative Integrated Care. For more information, see the [June 2023 release notes](/pdf/wcm/MerativeIntegratedCare_ReleaseNotes_June2023.pdf) on the release notes page.

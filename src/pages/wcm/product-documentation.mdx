...
In this release, we added further views to the bring-your-own-tool (BYOT) reporting solution. For updated documentation, see the following PDF addendum:

* [Watson Care Manager BYOT reporting documentation](/pdf/wcm/WatsonCareManager__Sep_PDF.pdf)

## August 2022 release

In this release, we added further views to the bring-your-own-tool (BYOT) reporting solution. For updated documentation, see the following PDF addendum:

* [Watson Care Manager BYOT reporting documentation](/pdf/wcm/WatsonCareManager_BYOT_PDF.pdf)
